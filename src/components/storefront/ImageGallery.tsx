...
export default function ImageGallery({ images, alt }: { images: string[]; alt: string }) {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 h-full">
      ...
      <div 
        className="relative flex-1 aspect-[3/4] md:aspect-auto md:h-[600px] bg-[#FAFAFA] overflow-hidden rounded-none cursor-zoom-in border border-[#B6925B]/20 order-1 md:order-2"
