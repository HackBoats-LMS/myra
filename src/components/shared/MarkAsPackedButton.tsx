...
export default function MarkAsPackedButton({ orderId }: { orderId: string }) {
  ...
  return (
    <button
      onClick={handlePack}
      disabled={loading}
      className="bg-[#B6925B] hover:bg-[#8e7246] text-white px-5 py-2.5 rounded-none text-[10px] font-bold uppercase tracking-widest transition-colors flex items-center justify-center gap-1.5 disabled:opacity-50"
    >
