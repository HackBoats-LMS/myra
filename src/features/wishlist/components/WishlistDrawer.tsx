        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          {loading ? (
            ...
            <div className="h-full flex flex-col items-center justify-center text-center space-y-6">
              ...
              <div>
                <p className="font-serif text-lg text-[#2D1F2F]">Your wishlist is empty</p>
                <p className="text-[10px] uppercase tracking-widest font-bold text-[#7A0B2E] mt-2">Save items you love to find them later</p>
              </div>
              <button
                onClick={closeWishlist}
                ...
                <div key={item.id} className="flex gap-4 pt-6 first:pt-0">
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <p className="text-sm font-bold text-[#7A0B2E] mt-1.5">₹{item.product.price.toLocaleString('en-IN')}</p>
                    </div>
                    ...
                    <div className="flex items-center justify-between mt-3">
                      <button
                        ...
                        className="border border-[#7A0B2E]/30 text-[#7A0B2E] hover:bg-[#7A0B2E] hover:text-white px-3 py-2 text-[10px] font-bold uppercase tracking-widest transition-colors flex items-center gap-1.5 disabled:opacity-50 rounded-none"
                      >
                        {busyId === item.id ? (
        ...
        {items.length > 0 && (
          <div className="border-t border-[#7A0B2E]/20 p-6 bg-[#F5EFE6] space-y-4">
            ...
            <button
              ...
              disabled={movingAll}
              className="w-full border border-[#7A0B2E]/30 text-[#7A0B2E] hover:bg-[#7A0B2E] hover:text-white py-3 text-[10px] font-bold uppercase tracking-widest transition-colors rounded-none disabled:opacity-50 flex items-center justify-center gap-1.5"
            >
              {movingAll ? (
                <i className="ri-loader-4-line animate-spin text-sm" />
              ) : (
