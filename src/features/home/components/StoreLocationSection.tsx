...
export default function StoreLocationSection() {
  ...
  return (
    <section className="w-full bg-[#EBDCD9] py-10 sm:py-14 md:py-16 lg:py-20 px-4 sm:px-6 md:px-8 lg:px-12 border-t border-[#7A0B2E]/10">
      <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row items-center justify-center gap-8 md:gap-8 lg:gap-14 xl:gap-20">
        ...
        <div className="flex flex-col items-center text-center w-full max-w-[480px] md:max-w-[380px] lg:max-w-[480px] px-2 sm:px-4 shrink-0">
          ...
          {/* Main Title */}
          <h2 className="font-serif text-2xl sm:text-3xl md:text-[23px] lg:text-[32px] xl:text-[36px] text-[#7A0B2E] tracking-normal leading-tight font-medium whitespace-normal md:whitespace-nowrap lg:whitespace-normal">
            Visit Myra Shopping Mall
          </h2>

          {/* Subtitle - tightly spaced below heading */}
          <h3 className="font-serif text-sm sm:text-base md:text-sm lg:text-lg xl:text-xl text-[#7A0B2E] font-normal tracking-wide mt-1.5 md:mt-1.5 lg:mt-2">
            Your Fashion Destination in Guntur
          </h3>

          {/* Description Paragraph */}
          <p className="font-serif text-[11px] sm:text-xs md:text-[11px] lg:text-[13px] text-[#7A0B2E] leading-relaxed mt-3 md:mt-3.5 lg:mt-5 max-w-[460px]">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-[#7A0B2E] hover:bg-[#5C0820] text-white px-5 sm:px-7 md:px-6 lg:px-8 py-2 sm:py-2.5 rounded-full font-serif text-[11px] sm:text-xs md:text-xs lg:text-[13px] tracking-wide transition-all duration-300 shadow hover:shadow-md hover:scale-[1.02] mt-3.5 md:mt-4 lg:mt-6 active:scale-95"
          >
            <svg
              width="18"
              height="22"
