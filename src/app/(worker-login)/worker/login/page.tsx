      ...
      <div className="w-full max-w-md bg-white p-8 border border-[#B6925B]/20 shadow-sm rounded-none">
        <div className="flex flex-col items-center mb-8">
          <div className="w-12 h-12 bg-[#4A3B2C] flex items-center justify-center mb-4 rounded-none">
            <i className="ri-tools-line text-xl text-[#B6925B]" />
          </div>
          <h1 className="text-3xl font-serif text-[#4A3B2C] tracking-wide">Worker Portal</h1>
          <p className="text-xs text-[#B6925B] uppercase tracking-widest mt-2 font-bold">Inventory & Shipping Staff</p>
        </div>
