...
import { deleteReview, setReviewApproved, replyToReview } from "@/actions/storefront/review";
              ...
              <td className="p-4 text-right whitespace-nowrap">
                <div className="flex items-center justify-end gap-1">
                  ...
                  <DeleteButton
                    ...
                    onSuccess={() => setReviews(reviews.filter((r) => r.id !== review.id))}
                    className="text-red-700 hover:text-red-900 p-2 hover:bg-red-50"
                  />
                </div>
              </td>
            </tr>
