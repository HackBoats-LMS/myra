...
import { addPincode, deletePincode, togglePincodeActive } from "@/actions/admin/admin";
                ...
                <tr key={p.id} className="hover:bg-[#FAFAFA] transition-colors">
                  ...
                  <td className="px-6 py-4 text-right">
                    <DeleteButton
                      id={p.id}
                      entityName="pincode"
                      deleteAction={deletePincode}
                      confirmMessage={`Remove pincode ${p.code}?`}
                      className="inline-flex items-center justify-center text-red-600 hover:text-red-800 transition-colors p-1"
                    />
                  </td>
                </tr>
              ))
