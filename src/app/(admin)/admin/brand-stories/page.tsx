...
export default async function AdminBrandStoriesPage() {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      {/* Header */}
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-[#B6925B]/20 pb-6">
        <div>
          <div className="flex items-center gap-2 text-xs font-bold text-[#B6925B] uppercase tracking-widest mb-1">
            <Sparkles className="w-3.5 h-3.5" /> Homepage Showcase
          </div>
          <h1 className="text-3xl font-serif font-bold text-[#4A3B2C] tracking-wide">Brand Stories</h1>
