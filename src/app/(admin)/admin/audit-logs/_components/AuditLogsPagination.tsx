...
export default function AuditLogsPagination({ totalPages, currentPage, actionFilter }: AuditLogsPaginationProps) {
  ...
  return (
    <div className="border-t border-[#7A0B2E]/20 px-4 py-3 flex items-center justify-between text-sm bg-[#FAFAFA]">
      ...
      <div className="flex items-center gap-2">
        {currentPage > 1 && (
          <Link
            ...
            className="px-3 py-1 bg-white border border-[#7A0B2E]/30 text-[10px] font-bold uppercase tracking-widest text-[#2D1F2F] hover:bg-[#FAFAFA] transition-colors"
          >
            Previous
          </Link>
        )}
