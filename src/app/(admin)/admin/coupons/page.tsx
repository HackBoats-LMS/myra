  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 rounded-none">
      <div className="flex items-center justify-between border-b border-[#7A0B2E]/20 pb-4">
        <div>
          <h2 className="text-3xl font-serif font-bold text-[#2D1F2F] tracking-wide">Coupons & Discounts</h2>
          <p className="text-xs text-[#7A0B2E] font-bold uppercase tracking-widest mt-2">Create and manage promo codes for your store</p>
        </div>
        <Link 
        ...
        <table className="w-full text-left text-sm text-[#2D1F2F]">
          <thead className="bg-[#F5EFE6] text-[#7A0B2E] text-[10px] uppercase font-bold tracking-widest border-b border-[#7A0B2E]/20">
            <tr>
              ...
              <th className="px-6 py-4 border-r border-[#7A0B2E]/10">Discount</th>
              <th className="px-6 py-4 border-r border-[#7A0B2E]/10">Usage Limits</th>
              ...
              coupons.map((coupon) => {
                ...
                return (
                  <tr key={coupon.id} className="hover:bg-[#F5EFE6] transition-colors group">
                    ...
                    <td className="px-6 py-4 text-[10px] text-gray-500 font-bold uppercase tracking-widest space-y-1 border-r border-[#7A0B2E]/10">
