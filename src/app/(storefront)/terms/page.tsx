  ...
  return (
    <div className="w-full bg-[#FAFAFA] min-h-screen">
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-10 md:py-24 prose prose-sm prose-slate">
        <h1 className="text-3xl md:text-4xl font-serif font-bold text-[#4A3B2C] mb-8 tracking-wide">Terms of Service</h1>
        ...
        <div className="space-y-8 text-gray-600 leading-relaxed text-sm">
          <section>
            <h2 className="text-lg font-bold text-[#4A3B2C] mb-3">1. Agreement to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#4A3B2C] mb-3">2. Account Management</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#4A3B2C] mb-3">3. Pricing and Availability</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#4A3B2C] mb-3">4. Limitation of Liability</h2>
            <p>
