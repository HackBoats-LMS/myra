...
export default function TermsPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 md:px-8 py-16 min-h-screen prose prose-sm prose-slate">
      <h1 className="text-3xl font-serif font-bold text-gray-900 mb-8 tracking-tight">Terms of Service</h1>
      ...
      <div className="space-y-8 text-gray-600 leading-relaxed text-sm">
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-3">2. Account Management</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-3">3. Pricing and Availability</h2>
          <p>
