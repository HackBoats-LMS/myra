    ...
    <div className="w-full bg-[#FAFAFA] min-h-screen">
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-10 md:py-24 space-y-12">
        <div className="text-center space-y-4">
          <h1 className="text-4xl md:text-5xl font-serif text-[#2D1F2F] tracking-wide">Our Story</h1>
        ...
        <div className="prose prose-md text-gray-600 mx-auto space-y-6 leading-relaxed">
          ...
          <h3 className="text-xl font-serif text-[#2D1F2F] pt-6">Our Philosophy</h3>
          <p>
          ...
          <div className="bg-white p-8 border border-[#7A0B2E]/20 flex flex-col md:flex-row gap-8 mt-12 justify-around text-center shadow-sm">
            <div>
              <h4 className="text-xl font-serif text-[#2D1F2F]">5k+</h4>
              <p className="text-xs text-[#7A0B2E] uppercase tracking-widest mt-2 font-bold">Delighted Clients</p>
            </div>
            <div>
              <h4 className="text-xl font-serif text-[#2D1F2F]">100%</h4>
              <p className="text-xs text-[#7A0B2E] uppercase tracking-widest mt-2 font-bold">Ethically Sourced</p>
            </div>
            <div>
              <h4 className="text-xl font-serif text-[#2D1F2F]">Complimentary</h4>
              <p className="text-xs text-[#7A0B2E] uppercase tracking-widest mt-2 font-bold">Shipping Worldwide</p>
            </div>
          </div>
        </div>
      </div>
