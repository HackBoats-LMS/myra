  ...
  return (
    <div className="w-full bg-[#F5EFE6] min-h-screen">
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-10 md:py-24 prose prose-sm prose-slate">
        <h1 className="text-3xl md:text-4xl font-serif font-bold text-[#2D1F2F] mb-8 tracking-wide">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-gray-600 leading-relaxed text-sm">
          <section>
            <h2 className="text-lg font-bold text-[#2D1F2F] mb-3">1. Information We Collect</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#2D1F2F] mb-3">2. How We Use Your Information</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#2D1F2F] mb-3">3. Data Security and RLS</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#2D1F2F] mb-3">4. Cookies</h2>
            <p>
