...
export default function ShippingPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 md:px-8 py-16 min-h-screen prose prose-sm prose-slate">
      <h1 className="text-3xl font-serif font-bold text-gray-900 mb-8 tracking-tight">Shipping & Delivery</h1>
      <p className="text-xs text-gray-400 uppercase tracking-widest mb-10">Last Updated: August 8, 2026</p>
      
      <div className="space-y-8 text-gray-600 leading-relaxed text-sm">
        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Complimentary Standard Shipping</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Processing Times</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-3">Delivery Estimates</h2>
          <p>
