    ...
    <div className="w-full bg-[#F5EFE6] min-h-screen rounded-none">
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-10 md:py-24 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 pt-6">
          {/* Contact Info */}
          <div className="space-y-8 bg-white border border-[#7A0B2E]/20 p-8 shadow-sm rounded-none">
            <h3 className="text-xl font-serif text-[#2D1F2F] tracking-wide">Reach Out</h3>
          ...
          {/* Contact Form */}
          <div className="bg-white p-8 border border-[#7A0B2E]/20 shadow-sm rounded-none">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-[#2D1F2F] uppercase tracking-wider mb-2">
                    Name
                  </label>
                  <input
                    required
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#7A0B2E] hover:bg-[#5C0820] text-white py-3 text-xs font-bold uppercase tracking-widest transition-colors flex items-center justify-center gap-2 disabled:opacity-50 mt-4 rounded-none"
              >
