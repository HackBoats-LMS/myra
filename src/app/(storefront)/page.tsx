  ...
  return (
    <>
      ...
      <div className="w-full bg-[#FAFAFA]">
        ...
        {/* 4. Marquee/Ticker */}
        <div className="w-full bg-[#B6925B] py-3 overflow-hidden flex items-center">
        ...
        <section className="w-full relative h-[400px] md:h-[600px]">
          <Image src="https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=1600&h=900&fit=crop" alt="Bridal Collection" fill className="object-cover" />
        ...
        <section className="w-full bg-[#B6925B] py-20 px-8">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-center gap-12 md:gap-24">
            <div className="relative w-full md:w-1/2 h-[300px] md:h-[400px]">
              <Image src="https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=800&h=800&fit=crop" alt="Curated Sarees" fill className="object-contain" />
            </div>
        ...
        <section className="w-full bg-white py-12 border-b border-[#B6925B]/20">
          <div className="max-w-5xl mx-auto flex justify-between px-8">
            <div className="flex flex-col items-center gap-3"><i className="ri-truck-line text-2xl text-[#B6925B]" /><span className="text-[10px] text-gray-500 uppercase tracking-widest text-center">Complimentary<br/>Shipping</span></div>
            <div className="flex flex-col items-center gap-3"><i className="ri-star-line text-2xl text-[#B6925B]" /><span className="text-[10px] text-gray-500 uppercase tracking-widest text-center">Premium<br/>Quality</span></div>
            <div className="flex flex-col items-center gap-3"><i className="ri-shield-check-line text-2xl text-[#B6925B]" /><span className="text-[10px] text-gray-500 uppercase tracking-widest text-center">Secure<br/>Checkout</span></div>
            <div className="flex flex-col items-center gap-3"><i className="ri-customer-service-2-line text-2xl text-[#B6925B]" /><span className="text-[10px] text-gray-500 uppercase tracking-widest text-center">24/7<br/>Support</span></div>
          </div>
        </section>
        ...
        <section className="max-w-6xl mx-auto py-24 px-8 flex flex-col md:flex-row items-center justify-center gap-12 md:gap-24">
          <div className="relative w-full md:w-1/3 h-[400px] rounded-sm overflow-hidden shadow-xl">
            <Image src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=800&h=600&fit=crop" alt="Myra Physical Store" fill className="object-cover" />
          </div>
          <div className="max-w-md text-center space-y-6">
            ...
            <p className="text-xs text-[#B6925B] font-bold"><i className="ri-map-pin-line mr-1" />123 Elite Avenue, Landmark Plaza, Chennai</p>
